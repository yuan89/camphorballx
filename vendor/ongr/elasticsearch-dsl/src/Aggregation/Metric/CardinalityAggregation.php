...
class CardinalityAggregation extends AbstractAggregation
{
    ...
    public function __construct($name, $field = null, $script = null, $precision_threshold = null, $rehash = null)
    {
        parent::__construct($name);
        $this->setField($field);
        $this->setScript($script);
        $this->setPrecisionThreshold($precision_threshold);
        $this->setRehash($rehash);
    }
