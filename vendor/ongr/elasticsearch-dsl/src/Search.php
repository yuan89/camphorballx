...
use ONGR\ElasticsearchDSL\SearchEndpoint\CollapseEndpoint;
...
class Search
{
    ...
    public function addCollapse($field)
    {
        $this->getEndpoint(CollapseEndpoint::NAME)->addField($field);
    ...
    {
        $collapseEndpoint = $this->getEndpoint(CollapseEndpoint::NAME);
        print_r($collapseEndpoint);
        exit;
        return $collapseEndpoint->getCollapse();
    }
